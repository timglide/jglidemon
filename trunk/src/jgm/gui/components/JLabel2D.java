...
public class JLabel2D extends JLabel {
	...
	public static void main(String argv[]) {
		...
		lbl = new JLabel2D("Java Source and Support With Color Gradient",
				JLabel.CENTER);
		lbl.setFont(bigFont);
		...
		lbl = new JLabel2D("Java Source and Support Filled With Image",
				JLabel.CENTER);
		lbl.setFont(bigFont);
		...
		lbl = new JLabel2D("Java Source and Support With Image Animation",
				JLabel.CENTER);
		lbl.setFont(bigFont);
		...
		lbl = new JLabel2D("Java Source and Support With Color Animation",
				JLabel.CENTER);
		lbl.setFont(bigFont);
		...
		JLabel lbl1 = new JLabel(
				"Plain Java Source and Support For Comparison", JLabel.CENTER);
